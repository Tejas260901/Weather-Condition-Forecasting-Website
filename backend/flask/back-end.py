...
# Configure logging
logging.basicConfig(filename='weatherstatus.log', level=logging.INFO)
...
def main():
    ...
    db_manager = DatabaseManager('weatherstatus.db')
    user_manager = UserManager(db_manager)
    weather_backend = WeatherStatusBackend(API_KEY)
